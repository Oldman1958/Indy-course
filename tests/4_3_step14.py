...
Друзья Лимака планируют устроить роскошную новогоднюю вечеринку, и Лимак хочет прибыть в полночь или ранее.
...
количество задач в соревновании и количество минут,
...
и приехать на вечеринку в 23:57 (через 222 минуты).
...
number_ex = 1
number_prev = 0
while (t_ans - t_ex * number_ex) >= 0:
    t_ans -= t_ex * number_ex
    if number_ex > n:
