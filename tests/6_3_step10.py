...
Ваша программа принимает на вход название валюты и проверяет,
присутствует ли данная валюта в словаре.

Если валюта присутствует, необходимо вывести ее курс,
если отсутствует - строку Нет данных по <валюта>
"""
...
money = input()
if money in currencies:
    print(currencies[money])
else:
    print(f"Нет данных по {money}")
