...
Гарантируется, что все номера разные.

В качестве ответа вам необходимо вывести получившийся словарь.

Вложенный список people задается во входных данных, поэтому считывать информацию вам не нужно.
Пользуйтесь сразу переменной people.
"""
